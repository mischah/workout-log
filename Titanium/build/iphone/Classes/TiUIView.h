...
/**
 Base class for all WorkoutLog views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the WorkoutLog view hierarchy (such as wrapped iOS UIViews) was touched.
